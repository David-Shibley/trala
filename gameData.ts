...
export const gameWithHeatCheckFinalRound: Round[] = [
  {
    made_shots: ["green1", "gray2", "red2"],
    attempted_shots: ["green1", "gray2", "blue2", "red2"],
  },
  {
    ...
    made_bonus_shots: ["green1", "green1", "green1"],
  },
];

export const gameWithHeatCheckNotFinalRound: Round[] = [
